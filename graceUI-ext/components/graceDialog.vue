...
.grace-dialog-shade{position:fixed; width:100%; height:100%; overflow:hidden; left:0; top:200rpx; bottom:0; z-index:9991; display:flex; justify-content:center; align-items:center;}
.grace-dialog{width:100%; background:#FFFFFF; position:absolute; top: 0rpx; border-top: 2rpx solid #eee;}
...
.grace-shade-in{animation:grace-shade-in-a 100ms linear forwards;}
@keyframes grace-shade-in-a{0%{transform: scale(0.1); opacity:0;} 100%{transform: scale(1); opacity:1;}}
.grace-shade-out{animation:grace-shade-out-a 100ms ease-out forwards;}
