...
<style>
.grace-nav-bar{width:100%; display:flex; white-space:nowrap; text-align: center;}
...
.nav-active-line{width:36rpx; height:6rpx; margin-top:5rpx; margin: 0 auto;}
.grace-nav-center{justify-content:center; text-align:center;}
.uni-scroll-view-content{text-align: center;}
</style>