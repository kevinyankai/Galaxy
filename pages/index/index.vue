	...
	<view class="content">
		...
		<view class="header">
			...
			<view class="header-con">
				...
				<view class="pro-des">Various data and creations on the chain. Get support from creators around the world.</view>
				<view class="pro-seach">2222</view>
				<view class="pro-cont">Trends: pictures, videos, audio...</view>
			</view>
		</view>
		<view class="tabar-box">
			<view class="tabar-title">
				<view :class="{tabbarchecked:index==nowIndex}" @click="tabbarchecked(index)" v-for="(item,index) in tabartitle" :key="index">{{item}}</view>
			</view>
		</view>
		<view v-if="nowIndex==0">
			<view class="content-cell">
				<view @click="gotoimgdetail" v-for="(item,index) in celllist">{{item}}</view>
			</view>
		</view>
		<view v-if="nowIndex==1">
			<view class="content-cell">
				<view @click="gotomusicdetail">gotomusicdetail</view>
			</view>
		</view>
		<view v-if="nowIndex==2">
			<view class="content-cell">
				<view @click="gotovideodetail">gotovideodetail</view>
			</view>
		</view>
	</view>
</template>
...
<script>
	export default {
		data() {
			return {
				nowIndex: 0,
				tabartitle: ['Pictures', 'Videos','Audio'],
				slidervalue:0,
				celllist:[1,2,3,4]
			}
		},
