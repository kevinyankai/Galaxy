<template>
	<view class="content">
		...
		<view class="resource-box">
			<view class="resource-title"><text class="resource-titleone">Owning data set</text><text class="resource-titletwo">【File
					name 】</text></view>
				...
				<view class="left">
					...
					<view class="left-top-cell" v-for="(item,index) in celllist" :key="index">
						<view>
							...
							<view class="left-top-title">flower<text class="text-right">05:56</text></view>
